            ...
            <div class="home-product">
                <div class="grid__row">
                    <div class="home__product-label">
                        ...
                        <a target="_blank" href="index.html?` + filter.join('&') + `" class="home__product-view-all">Xem tất cả</a>
                    </div>
            `;
...
function addCategory(tenCategory, filter, ele) {
    var s = `
                <li class="category-item">
                    <a target="_blank" href="index.html?` + filter.join('&') + `" class="category-item__link">` + tenCategory + `</a>
                </li>
    `;
    ele.innerHTML += s;
}
